...
export default {
  validations: {
    data: {
      last_name: { required, alpha, maxLength: maxLength(255) },
      first_name: { required, alpha, maxLength: maxLength(255) },
      middle_name: { alpha, maxLength: maxLength(255) },
      suffix: {},
      birthday: {
        required,
        validBirthday(value) {
